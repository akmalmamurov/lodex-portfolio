...
const Services = () => {
  return (
    <section id="services" className="py-[100px]">
      <h2 className="text-center font-bold text-linkColor text-[50px] uppercase mb-[60px]">
        Xizmatlarimiz
      </h2>
      <div className="flex flex-col gap-[46px]">
        {/* column 1 */}
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-[96px]">
          <Card
            title={"Veb - saytlar"}
        ...
        {/* column 4 */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[96px]">
          <Card
