...
const AboutMid = () => {
  return (
    <div className="grid grid-cols-1 gap-2 lg:gap-20 lg:grid-cols-2 place-items-center my-8">
      ...
      <div className="">
        <h2 className="font-semibold text-[48px] lg:text-[65px] leading-[80px] text-linkColor">
          Hamyonbop <span className="text-titleSpan">narxlar </span>
        </h2>
        <p className="font-normal lg:font-medium text-xl lg:text-2xl  lg:leading-[38px] text-linkColor lg:w-[448px]">
