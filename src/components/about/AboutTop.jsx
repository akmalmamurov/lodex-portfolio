...
const AboutTop = () => {
  return (
    <div className="grid grid-cols-1 gap-2 lg:gap-20 lg:grid-cols-2 place-items-center">
      <div className="">
        <h2 className="font-semibold text-center text-[32px] mdl:text-left mdl:text-[48px] lg:text-[65px] leading-[97.5px] text-linkColor">Kuchli <span className="text-titleSpan">jamoa</span></h2>
