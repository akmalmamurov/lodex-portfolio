...
const AboutBottom = () => {
  return (
    <div className="grid grid-cols-1 gap-2 lg:gap-20 lg:grid-cols-2 lg:place-items-center">
      <div className="">
        <h2 className="font-semibold text-center mdl:text-left text-[32px] mdl:text-[48px] lg:text-[65px] flex-row lg:leading-[84.5px] text-linkColor lg:flex lg:flex-col">
